...
export default function HeroSection() {
  return (
    <section className='relative container left-1/2 -translate-x-1/2 w-[90%] pt-24 pb-24 lg:pt-30'>
      ...
      <div className='relative z-1'>
        ...
        {/* Paragraph */}
        <p className='text-xs lg:text-lg text-zinc-300/80 mb-8 text-left w-[100%] lg:w-[60%]'>
